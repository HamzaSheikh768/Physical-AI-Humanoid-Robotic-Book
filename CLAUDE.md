...
## Active Technologies
- Markdown/MDX for Docusaurus documentation framework + Docusaurus documentation system, TypeScript for customization if needed (001-intro-physical-ai)
- Files stored in docs/ directory following Docusaurus structure (001-intro-physical-ai)
